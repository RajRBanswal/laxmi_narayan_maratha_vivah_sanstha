                ...
                <div class="tab-content bg-light" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="pills-recieved" role="tabpanel" aria-labelledby="pills-recieved-tab">
                        ...
                        <div class="card-body ">
                            <div class="row mb-4">
                                ...
                                // print_r(mysqli_num_rows($requests));
                                                    ...
                                                    if ($stat != 1 || $count == 0) {
                                                        ...
                                                        if ($expi > $currentDate) {
                                                            ...
                                                            ?>
                                                                <div class="col-md-6  col-lg-6 ">
                                                                    <div class="row vendor-list-block mb30 shadow profile align-items-center">
                                                                        ...
                                                                        <div class="col-md-6 col-xs-6 col-sm-6 ">
                                                                            <div class="<?php echo $row['label']; ?>"></div>
                                                                            <!--<img src="user_image/<?php echo $row['filename']; ?>" alt="wedding venue" class="match-img py-0" >-->
                                                                            <a data-bs-toggle="modal" data-bs-target="#confirmnine<?php echo $row['id']; ?>" class=" mt-1" name="Req" id="Req"><img src="user_image/<?php echo $row['filename']; ?>" alt="wedding venue" class="match-img py-0"></a>
                                                                        </div>
                                                                        <div class="col-md-6 col-xs-6 col-sm-6">
                                                                            <p class="text-pink mb-0 fw-bold">ID :- <?php echo $row['member_id']; ?></p>
                                                                            <p class="text-dark mb-0">DOB :- <?php echo $row['bDate']; ?></p>
                                                                ...
                                                                <!-- ======================================== -->
                                                                <div class="modal fade" id="confirmnine<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <form action="" method="post">
                                                                                <div class="modal-header">
                        ...
                        <div class="card-body">
                            <div class="row mb-4">
                                ...
                                ?>
                                                    <div class="col-md-6  col-lg-6 ">
                                                        <div class="row vendor-list-block mb30 shadow profile align-items-center">
                                                            ...
                                                            <div class="col-md-6 col-xs-6 col-sm-6 ">
                                                                <div class="<?php echo $row['label']; ?>"></div>
                                                                <!--<img src="user_image/<?php echo $row['filename']; ?>" alt="wedding venue" class="match-img py-0" >-->
                                                                <a data-bs-toggle="modal" data-bs-target="#confirmtwo<?php echo $row['id']; ?>" class=" mt-1" name="Req" id="Req"><img src="user_image/<?php echo $row['filename']; ?>" alt="wedding venue" class="match-img py-0"></a>
                                                            </div>
                                                            <div class="col-md-6 col-xs-6 col-sm-6">
                                                                <p class="text-pink mb-0 fw-bold">ID :- <?php echo $row['member_id']; ?></p>
                                                                <p class="text-dark mb-0">DOB :- <?php echo $row['bDate']; ?></p>
                                                    ...
                                                    <div class="modal fade" id="confirmtwo<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <form action="" method="post">
                                                                    <div class="modal-header">
                                            ...
                                            if ($stat != 1 || $count == 0) {
                                                ...
                                                if ($expi > $currentDate) {    // echo $ro['user_id'] ;
                                                    ...
                                                    ?>
                                                        <div class="col-md-6  col-lg-6 ">
                                                            <div class="row vendor-list-block mb30 shadow profile align-items-center">
                                                                ...
                                                                <div class="col-md-6 col-xs-6 col-sm-6 ">
                                                                    <div class="<?php echo $row['label']; ?>"></div>
                                                                    <!--<img src="user_image/<?php echo $row['filename']; ?>" alt="wedding venue" class="match-img py-0" >-->
                                                                    <a data-bs-toggle="modal" data-bs-target="#confirmthr<?php echo $row['id']; ?>" class=" mt-1" name="Req" id="Req"><img src="user_image/<?php echo $row['filename']; ?>" alt="wedding venue" class="match-img py-0"></a>
                                                                </div>
                                                                <div class="col-md-6 col-xs-6 col-sm-6">
                                                                    <p class="text-pink mb-0 fw-bold">ID :- <?php echo $row['member_id']; ?></p>
                                                                    <p class="text-dark mb-0">DOB :- <?php echo $row['bDate']; ?></p>
                                                        ...
                                                        <div class="modal fade" id="confirmthr<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <form action="" method="post">
                                                                        <div class="modal-header">
                    ...
                    <div class="tab-pane fade show " id="pills-likes" role="tabpanel" aria-labelledby="pills-likes-tab">
                        ...
                        <div class="card-body">
                            <div class="row mb-4">
                                <?php $rid = 0;
                                $liked = mysqli_query($conn, "SELECT * FROM `shortlist` WHERE `liked_p_id`= '$sesn_id' AND `status` = 1 ");
                                $count = mysqli_num_rows($liked);    // echo $count.'<br>';
                                while ($ro = mysqli_fetch_array($liked)) {
                                    // echo $ro['id'];
                                    $rid = $ro['id'];  //echo $count . '<br>';                                                                                                                                                                            
                                    $otherid = $ro['user_id'];   // echo  $otherid . 'user id <br>';      
                                    $likepid = $ro['liked_p_id'];
                                    $planType = "";      // echo  $likepid. 'like p id <br>';                                                                                                    
                                    $liked2 = mysqli_query($conn, "SELECT * FROM `shortlist` WHERE `liked_p_id` = '$otherid' AND `user_id` = '$sesn_id' AND `status` = 1 ");
                                    $count2 = mysqli_num_rows($liked2);
                                    // echo '<br>' . $otherid;       echo '<br>'.$count2.'<br>';           // $stat = $r['status'];  
                                    if ($count2 > 0) {     // echo  $otherid . 's';   
                                        $currentDate = date("Y-m-d");
                                        $user_reg = mysqli_query($conn, "SELECT * FROM `user_regiter` WHERE `id` = '$otherid' AND `status` = 1 ");
                                ...
                                ?>
                                                <div class="col-md-6  col-lg-6 ">
                                                    <div class="row vendor-list-block mb30 shadow profile align-items-center">
                                                        ...
                                                        <div class="col-md-6 col-xs-6 col-sm-6 ">
                                                            <div class="<?php echo $row['label']; ?>"></div>
                                                            <!--<img src="user_image/<?php echo $row['filename']; ?>" alt="wedding venue" class="match-img py-0" >-->
                                                            <a data-bs-toggle="modal" data-bs-target="#confirmfr<?php echo $row['id']; ?>" class=" mt-1" name="Req" id="Req"><img src="user_image/<?php echo $row['filename']; ?>" alt="wedding venue" class="match-img py-0"></a>
                                                        </div>
                                                        <div class="col-md-6 col-xs-6 col-sm-6">
                                                            <p class="text-pink mb-0 fw-bold">ID :- <?php echo $row['member_id']; ?></p>
                                                            <p class="text-dark mb-0">DOB :- <?php echo $row['bDate']; ?></p>
                                                ...
                                                <div class="modal fade" id="confirmfr<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form action="" method="post">
                                                                <div class="modal-header">
                                            ...
                                            ?>
                                                <div class="col-md-6  col-lg-6 ">
                                                    <div class="row vendor-list-block mb30 shadow profile align-items-center">
                                                        ...
                                                        <div class="col-md-6 col-xs-6 col-sm-6 ">
                                                            <div class="<?php echo $row['label']; ?>"></div>
                                                            <!--<img src="user_image/<?php echo $row['filename']; ?>" alt="wedding venue" class="match-img py-0" >-->
                                                            <a data-bs-toggle="modal" data-bs-target="#confirmfv<?php echo $row['id']; ?>" class=" mt-1" name="Req" id="Req"><img src="user_image/<?php echo $row['filename']; ?>" alt="wedding venue" class="match-img py-0"></a>
                                                        </div>
                                                        <div class="col-md-6 col-xs-6 col-sm-6">
                                                            <p class="text-pink mb-0 fw-bold">ID :- <?php echo $row['member_id']; ?></p>
                                                            <p class="text-dark mb-0">DOB :- <?php echo $row['bDate']; ?></p>
                                                ...
                                                <div class="modal fade" id="confirmfv<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form action="" method="post">
                                                                <div class="modal-header">
                                        ...
                                        while ($row = mysqli_fetch_array($user_reg)) {
                                            ...
                                            ?>
                                                <div class="col-md-6  col-lg-6 ">
                                                    <div class="row vendor-list-block mb30 shadow profile align-items-center">
                                                        ...
                                                        <div class="col-md-6 col-xs-6 col-sm-6 ">
                                                            <div class="<?php echo $row['label']; ?>"></div>
                                                            <!--<img src="user_image/<?php echo $row['filename']; ?>" alt="wedding venue" class="match-img py-0" >-->
                                                            <a data-bs-toggle="modal" data-bs-target="#confirmsx<?php echo $row['id']; ?>" class=" mt-1" name="Req" id="Req"><img src="user_image/<?php echo $row['filename']; ?>" alt="wedding venue" class="match-img py-0"></a>
                                                        </div>
                                                        <div class="col-md-6 col-xs-6 col-sm-6">
                                                            <p class="text-pink mb-0 fw-bold">ID :- <?php echo $row['member_id']; ?></p>
                                                            <p class="text-dark mb-0">DOB :- <?php echo $row['bDate']; ?></p>
                                                ...
                                                <div class="modal fade" id="confirmsx<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form action="" method="post">
                                                                <div class="modal-header">
                                                ...
                                                <div class="col-md-6  col-lg-6 ">
                                                    <div class="row vendor-list-block mb30 shadow profile align-items-center">
                                                        ...
                                                        <div class="col-md-6 col-xs-6 col-sm-6 ">
                                                            <div class="<?php echo $row['label']; ?>"></div>
                                                            <!--<img src="user_image/<?php echo $row['filename']; ?>" alt="wedding venue" class="match-img py-0" >-->
                                                            <a data-bs-toggle="modal" data-bs-target="#confirmsvn<?php echo $row['id']; ?>" class=" mt-1" name="Req" id="Req"><img src="user_image/<?php echo $row['filename']; ?>" alt="wedding venue" class="match-img py-0"></a>
                                                        </div>
                                                        <div class="col-md-6 col-xs-6 col-sm-6">
                                                            <p class="text-pink mb-0 fw-bold">ID :- <?php echo $row['member_id']; ?></p>
                                                            <p class="text-dark mb-0">DOB :- <?php echo $row['bDate']; ?></p>
                    ...
                    <div class="tab-pane fade show " id="pills-deleted" role="tabpanel" aria-labelledby="pills-deleted-tab">
                        ...
                        <div class="card-body">
                            <div class="row rejectedprofile profile mb-4">
                            </div>
                        </div>
                    </div>
                </div>
